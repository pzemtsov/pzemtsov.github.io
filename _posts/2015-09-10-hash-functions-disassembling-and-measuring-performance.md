...
it here (I've placed it in a [repository]({{ site.REPO-LIFE }}/blob/10a1a8731f9d2900ef304bd8986654fd945a32ce/java8_iterate_long.asm)). It is also very complex -- it's enough to mention that it contains 49 branch
...
(it can be seen [here]({{ site.REPO-LIFE }}/blob/10a1a8731f9d2900ef304bd8986654fd945a32ce/java8_sum_point.asm)). I'll show my reconstruction of its pseudo-code:
...
(the full code is [here]({{ site.REPO-LIFE }}/blob/10a1a8731f9d2900ef304bd8986654fd945a32ce/java8_sum_long.asm)). The
