...
Fortunately, the problem is limited to the most
...
Now we can remove `Unrolled_3` and `Unrolled4` ([the code is here]({{ site.REPO-E1-C }}/commit/ed29557be68e178600e7f2139330bcbdd724fe9f)),
...
- Unlike in **Java**, one of the `Src_First` versions (namely, `Src_First_2`) runs faster than the `Dst_First` versions
